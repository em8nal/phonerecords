    ...
    sections: [
      {
        ...
        body: `PHŌNÉ Records · representada por Enrique Ariel Camhi Ibarlucea · Eduardo Castillo Velasco 2325, depto A, Ñuñoa, Región Metropolitana, Chile. Email de contacto para asuntos de privacidad: contacto@phonerecords.cl.`,
      },
      {
...
Si nos escribes por email (contacto@phonerecords.cl, press@phonerecords.cl, booking@phonerecords.cl), conservamos tu mensaje para responderte. No lo usamos para nada más.`,
      },
      {
...
Para ejercer cualquiera de estos derechos, escribe a contacto@phonerecords.cl. Te respondemos en un plazo máximo de 30 días.`,
      },
      {
        title: "6 · Retención",
    ...
    sections: [
      {
        ...
        body: `PHŌNÉ Records · represented by Enrique Ariel Camhi Ibarlucea · Eduardo Castillo Velasco 2325, apt A, Ñuñoa, Región Metropolitana, Chile. Contact email for privacy matters: contacto@phonerecords.cl.`,
      },
      {
...
If you write to us by email (contacto@phonerecords.cl, press@phonerecords.cl, booking@phonerecords.cl), we keep your message to respond. We don't use it for anything else.`,
      },
      {
...
To exercise any of these rights, write to contacto@phonerecords.cl. We respond within a maximum of 30 days.`,
      },
      {
        title: "6 · Retention",
